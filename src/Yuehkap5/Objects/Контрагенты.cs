    ...
    public class Контрагенты : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрагентыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентыE", typeof(IIS.Yuehkap5.Контрагенты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрагентыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентыL", typeof(IIS.Yuehkap5.Контрагенты));
                }
            }
        }
    }
